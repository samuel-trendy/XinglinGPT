...
#DEFAULT_CKPT_PATH = '/data/base_models/Qwen2.5-7B-Instruct'
DEFAULT_CKPT_PATH = '/data/pretrain_models/Xinglin-7B-20241105-1-1e7'
...
def _chat_stream(model, tokenizer, query, history):
    ...
    rtn = tokenizer.decode(pred.cpu()[0], skip_special_tokens=True)
    return rtn
    '''
